...
type TaskRepository interface {
	...
	GetTaskByID(ctx context.Context, id int, parentID int) (*models.Task, error)                         // ParentID untuk cek kepemilikan
...
type RewardRepository interface {
	...
	GetRewardByID(ctx context.Context, id int, parentID int) (*models.Reward, error) // Cek kepemilikan? Atau semua parent bisa lihat?
